    ...
    <div class="admin-page">
      ...
      <div class="card-grid">
        <a class="admin-nav-card" routerLink="/admin/faq">
          <span class="card-icon"><app-icon name="circle-question-mark" [size]="20" /></span>
          <div>
            <h3>FAQ</h3>
        ...
        <a class="admin-nav-card" routerLink="/admin/directory">
          <span class="card-icon"><app-icon name="users" [size]="20" /></span>
          <div>
            <h3>Annuaire</h3>
        ...
        <a class="admin-nav-card" routerLink="/admin/campus-plan">
          <span class="card-icon"><app-icon name="map" [size]="20" /></span>
          <div>
